...
export default function About() {
  ...
  return (
    <>
      ...
      <div className="w-full max-w-[1200px] mx-auto p-6 md:p-8 overflow-x-auto overflow-y-auto">      <div className="w-full max-w-[1200px] mx-auto p-6 md:p-8 overflow-x-auto">
