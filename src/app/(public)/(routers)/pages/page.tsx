    ...
    <div className="bg-white min-h-screen flex flex-col font-sans">
      ...
      {/* Navigation bar */}
          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mb-14">
              {filteredProjects.map((project, idx) => (
                <article className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden flex flex-col group relative" key={idx}>
                  <div className="relative">
                    <img
                      ...
                      width="400"
                    />
                    <div className="absolute bottom-0 left-0 right-0 flex h-14">
                      <div className="flex-1 bg-[#071B2F] flex items-center px-6">
                        <h3 className="text-[17px] font-bold text-[#F9B826] truncate">
                          Lorem ipsum dolor sit
                        </h3>
                      </div>
                      <button
                        aria-label="Expand project details"
                        className="bg-[#F9B826] border-l border-[#071B2F] flex items-center justify-center w-14 h-full transition"
                      >
                        <span className="text-3xl text-white font-light leading-none">+</span>
                      </button>
                    </div>
                  </div>
                  <div className="bg-[#f6f8fa] px-7 py-6 flex flex-col items-center">
                    <div className="text-[14px] text-[#888] mb-2">
                      <span className="italic">By Admin</span>
                      <span className="mx-1">_</span>
                      <span className="italic">In Construction</span>
                    </div>
                    <div className="text-[15px] text-[#444] text-center leading-relaxed">
