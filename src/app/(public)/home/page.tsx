...
<ul className="flex flex-wrap justify-center md:justify-start gap-6 text-base font-semibold mt-3 md:mt-0">
  <li>
    <a className="text-[#f9b707] hover:text-[#f9b707] transition" href="/templet">HOME</a>
  </li>
  <li>
  ...
  <li>
    <a className="hover:text-[#f9b707] transition" href="/templet/service">SERVICE</a>
  </li>
  <li>
    <a className="hover:text-[#f9b707] transition" href="/templet/team">TEAM</a>
  </li>
  <li>
    <a className="hover:text-[#f9b707] transition" href="#">PROJECT</a>
  </li>
  <li className="relative group cursor-pointer">
    ...
    <ul className="absolute left-0 top-full min-w-[180px] bg-white shadow-lg border border-gray-100 rounded z-20 opacity-0 group-hover:opacity-100 group-hover:pointer-events-auto pointer-events-none transition-opacity duration-200 mt-2">
      <li>
        <Link href="/templet/about" className="block px-4 py-2 text-[#071B2F] hover:bg-[#f9b707] hover:text-white transition font-medium">About</Link>
      </li>
      <li>
        <Link href="/templet/contact" className="block px-4 py-2 text-[#071B2F] hover:bg-[#f9b707] hover:text-white transition font-medium">Contact</Link>
      </li>
      <li>
        <Link href="/templet/pages" className="block px-4 py-2 text-[#071B2F] hover:bg-[#f9b707] hover:text-white transition font-medium">Page</Link>
      </li>
      <li>
        <Link href="/templet/project" className="block px-4 py-2 text-[#071B2F] hover:bg-[#f9b707] hover:text-white transition font-medium">Project</Link>
      </li>
      <li>
        <Link href="/templet/service" className="block px-4 py-2 text-[#071B2F] hover:bg-[#f9b707] hover:text-white transition font-medium">Service</Link>
      </li>
      <li>
        <Link href="/templet/team" className="block px-4 py-2 text-[#071B2F] hover:bg-[#f9b707] hover:text-white transition font-medium">Team</Link>
      </li>
    </ul>
  </li>
  <li>
    <Link href="/templet/contact" className="hover:text-[#f9b707] transition">
      CONTACT
    </Link>
  </li>
</ul>
