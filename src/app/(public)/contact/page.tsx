  ...
  return (
    <div className="bg-white min-h-screen flex flex-col font-sans">
      ...
      {/* Navigation bar */}
        ...
        <header className="bg-[#f9b72b] py-12 text-center">
          <h1 className="text-3xl font-extrabold text-[#0a142f] underline inline-block">Contact Us</h1>
          <nav className="mt-2 text-sm text-[#0a142f] font-normal">
            Home / Contact Us
          </nav>
        </header>
