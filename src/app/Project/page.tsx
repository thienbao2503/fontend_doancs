  ...
  return (
    <>
      <Head>
        ...
        <title>Your Projects Dashboard</title>
      </Head>

      {/* Main Content */}
      <div className="bg-[#f7f9fc] p-4 sm:p-6 md:p-10">
        <div className="max-w-[1280px] mx-auto space-y-6">
          {/* Header */}
          <header className="bg-white rounded-xl shadow-[0_10px_20px_rgba(0,0,0,0.05)] flex flex-col sm:flex-row items-center justify-between px-6 py-4">
